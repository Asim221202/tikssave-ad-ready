      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            Save your favorite TikTok videos in high quality without watermarks.
            ...
            <div className="relative bg-card/50 backdrop-blur-xl rounded-3xl p-8 border border-border/50 shadow-[var(--shadow-card)]">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Input
                  ...
                  text-base bg-background/50 border-border/50 focus:border-primary"
                  disabled={loading}
                />
                <Button
              ...
              >
                ...
                <div className="relative bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300">
                  <div className="w-12 h-12 
                    rounded-xl bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center mb-4 shadow-[var(--shadow-glow)]">
              ...
              <div key={index} className="flex gap-6 items-start group">
                <div className="relative">
                  ...
                  <div className="relative w-16 
                    h-16 rounded-2xl bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center flex-shrink-0">
